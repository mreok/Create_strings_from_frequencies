def create_strings_from_characters(frequencies, string1, string2):
    can_create_string1 = can_create_strings_from_frequencies(frequencies,string1)
    can_create_string2 = can_create_strings_from_frequencies(frequencies,string2)
...
def can_create_strings_from_frequencies(frequencies, string):
